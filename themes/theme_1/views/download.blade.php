                    ...
                    <div class="col">
                        <a href="/download/{{ $DocumentCategory->slug }}">
                            <div class="card shadow-sm">
                                ...
                                <img src="{{ $DocumentCategory->thumb ? asset('storage/' . $DocumentCategory->thumb) : 'https://via.placeholder.com/150' }}"
                                    class="card-img-top" alt="Thumbnail" style="height: 250px; object-fit: cover;">
